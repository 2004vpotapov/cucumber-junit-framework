Feature: Some of the general functionality verifications
  ...
  Scenario: Order placement scenario
    ...
    And user enters customer name "Jane Doe12"
    ...
    Then user should see "Jane Doe12" in the first row of the web table
  ...
  Scenario Outline: Order placement scenario
    ...
    And user selects payment option "<paymentTypes>"
    ...
    Examples:
      | quantity | customerName | street | city | state | zip | paymentTypes | cardNumber | expDate | expectedName |
